...
const socialLinks = [
  {
    name: "facebook",
    href: "https://www.facebook.com/iqbenchmark",
    icon: <FacebookIcon fontSize="small" />,
  },
  {
    name: "instagram",
    href: "https://www.instagram.com/iqbenchmark",
    icon: <InstagramIcon fontSize="small" />,
  },
  {
    name: "tiktok",
    href: "https://www.tiktok.com/@iqbenchmark_official",
      ...
      <Container sx={{ pb: 6, pt: 3, align: "center" }}>
        ...
        >
          ...
          <Typography
            ...
            align="right"
          >
            &copy; 2022 Iqbenchmark. All rights reserved.
          </Typography>
        </Box>
      </Container>
    </Box>
